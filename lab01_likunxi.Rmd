...
The shapefile used in this case consists names of counties in Michigan State, so we can create a boxplot of the NDVI trend values of some of the counties to find whether there are huge differences among these counties. We choose
